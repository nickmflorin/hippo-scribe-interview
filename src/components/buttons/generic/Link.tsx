...
export type LinkFlexProps<F extends types.ButtonForm> = Omit<
  types.AbstractButtonProps<"link", F>,
  "buttonType"
> &
...
const Base = AbstractButton as React.FC<types.AbstractButtonProps<"link", any>>;
...
const LocalLink = forwardRef<types.PolymorphicButtonElement<any>, LinkProps<any>>(
  <F extends types.ButtonForm>(
    ...
    const ps = { ...props, iconSize, buttonType: "link", ref } as types.AbstractButtonProps<
      "link",
      /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
      any
    > & {
...
const withVariants = [...types.ButtonVariants.link].reduce<WithVariants>(
  (acc, variant) => ({
    ...acc,
